...
function feval(x)
    ...
    for i=1, numberOfPasses do
    	...
    	print(torch.typename(grad_crit))
    	print(grad_crit:size())
    	print(torch.typename(dkappa))
    		print(dkappa:size())
    	print(torch.typename(dh1_w))
    		print(dh1_w:size())
    	print(torch.typename(dlstm_c_h1))
    		print(dlstm_c_h1:size())
    	print(torch.typename(dlstm_h_h1))
    		print(dlstm_h_h1:size())
    	print(torch.typename(dlstm_c_h2))
    		print(dlstm_c_h2:size())
    	print(torch.typename(dlstm_h_h2))
    		print(dlstm_h_h2:size())
    	print(torch.typename(dlstm_c_h3))
    		print(dlstm_c_h3:size())
    	print(torch.typename(dlstm_h_h3))
    		print(dlstm_h_h3:size())
            -- model
